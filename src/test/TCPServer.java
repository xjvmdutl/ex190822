...
public class TCPServer {
	...
	public static void main(String[] args) {
		...
		try {
			...
			//InetSocketAddress inetSocketAddress=new InetSocketAddress(inetSocketAddress,PORT);//이거도 가능
			//InetSocketAddress inetSocketAddress=new InetSocketAddress("127.0.0.1",PORT);//장소,port번호
													//127.0.0.1 = loopback주소(자기 자신을 ip을 쓰면 라우터를 찍고 와야하지만 loopback주소를 쓰면 내부적으로 돌아온다) 
